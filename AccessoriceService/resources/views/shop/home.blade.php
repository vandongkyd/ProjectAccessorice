    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <ol class="carousel-indicators">
            @foreach($banners as $banner)
                <li data-target="#carouselExampleIndicators" data-slide-to="{{$banner->sort_no}}"
                    class="{{$banners[$default]->sort_no == $banner->sort_no ? 'active' : '' }}"></li>
            @endforeach
        </ol>
        @foreach($banners as $banner)
            <div class="carousel-item item1 {{$banners[$default]->sort_no == $banner->sort_no ? 'active' : '' }}">
                <img src="{{asset('upload')}}/{{$banner->banner_img}}" class="custom_banner" alt="">
                <div class="container">
                    <div class="storesl-space-banner">
                        <div class="carousel-caption p-lg-5 p-sm-4 p-3">
                            <div>{!! $banner->banner_description !!}</div>
        ...
        <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button"
           data-slide="prev">
            ...
            <span class="sr-only">{{__('messages.btn_previous')}}</span>
        </a>
        <a class="carousel-control-next" href="#carouselExampleIndicators" role="button"
           data-slide="next">
            <span class="carousel-control-next-icon" aria-hidden="true"></span>
            <span class="sr-only">{{__('messages.btn_next')}}</span>
        </a>
    </div>
@stop
                    ...
                    <div class="wrapper">
                        ...
                        <div class="product-sec1 product-sec2 px-sm-5 px-3">
                            <div class="row">
                                ...
                                <p class="storesl-nut-middle">Get Extra 10% Off</p>
