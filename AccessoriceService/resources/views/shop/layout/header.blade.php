    ...
    <div class="container">
        <div class="row header-bot_inner_electronics-stroeinfo_header_mid">
            ...
            <div class="col-md-3 logo_electronics">
                <img src="{{asset('/img/newlogo.png')}}" class="logo_project">
            </div>
            <!-- //logo -->
            <!-- header-bot -->
            <div class="col-md-9 header mt-5 mb-md-0 mb-4">
                <div class="row">
                    <!-- search -->
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto text-center mr-xl-5">
                    <li class="nav-item active mr-lg-2 mb-lg-0 mb-2">
                        <a class="nav-link" href="{{ url('home') }}">{{Lang::get('messages.lbl_title_home')}}
