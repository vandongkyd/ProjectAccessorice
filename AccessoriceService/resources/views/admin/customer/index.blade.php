...
@section('title', 'Accessories | '.__('messages.lbl_screen_menu.customers'))

@section('content-heading')
    <h3 class="title">{{__('messages.lbl_screen_menu.customers')}} <span>/ {{__('messages.lbl_header_list')}}</span></h3>
@stop
