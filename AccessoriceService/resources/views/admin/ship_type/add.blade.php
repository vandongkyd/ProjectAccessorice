...
@section('title', 'Accessories | '.__('messages.lbl_screen_menu.create',['name' => __('messages.lbl_screen_menu.ship')]))

@section('content-heading')
    <h3 class="title">{{__('messages.lbl_screen_menu.ship')}} <span>/ {{__('messages.lbl_header_add')}}</span></h3>
@stop
    ...
    <div class="row">
        <div class="col-12 mb-30">
            <div class="box">
                <div class="box-head">
                    <div class="row">
                        <h3 class="title col-lg-10 col-12">{{__('messages.lbl_screen_menu.create',['name' => __('messages.lbl_screen_menu.ship')])}}</h3>
                    </div>
                </div>

                <div class="col-lg-12 col-12 mb-30">
                    <div class="box-body">
                        <form id="f_submit" action="{{ route("ship.type.submit.add") }}" method="post" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="row mbn-20">
                                        <div class="col-12 mb-20">
                                            ...
                                            <input type="text" id="ship_name" class="form-control"
                                                   name="ship_name" value="{{old('ship_name')}}"
                                        ...
                                        <div class="col-12 mb-20">
                                            ...
                                            <input type="text" id="ship_price" class="form-control"
                                                   name="ship_price" value="{{old('ship_price')}}"
                                        ...
                                        <div class="col-12 mb-20">
                                            ...
                                            <select id="ship_status" class="form-control" name="ship_status">
                                                @foreach(__('messages.lbl_status_list') as $key => $value)
                                                    <option {{old("ship_status") == $key ? 'selected' : ''}} value="{{$key}}">{{$value}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
