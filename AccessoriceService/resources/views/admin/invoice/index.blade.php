...
@section('title', 'Accessories | '.__('messages.lbl_screen_menu.invoice'))

@section('content-heading')
    <h3 class="title">{{__('messages.lbl_screen_menu.invoice')}} <span>/ {{__('messages.lbl_header_list')}}</span></h3>
@stop
    ...
    <div class="row">
        ...
        <div class="col-12 mb-30">
            <div class="box">
                <div class="box-head">
                    <div class="row">
                        <h3 class="title col-lg-10 col-12">{{__('messages.lbl_screen_menu.list',['name' => __('messages.lbl_screen_menu.invoice')])}}</h3>
                        <div class="col-lg-2 col-12 text-right">
                            <a href="{{route("invoice.add")}}" role="button" class="button button-sm button-outline button-primary button-long text-center">
                ...
                <div class="box-body">
                    <table class="table table-bordered data-table data-table-default table-list text-center ">
                        ...
                        <tr>
                            ...
                            {{--<th>{{__('messages.lbl_table_invoice.address')}}</th>--}}
                        ...
                        @foreach($invoices as $invoice)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{url('admins/invoice/detail')}}/{{$invoice->id}}" data-toggle="tooltip" data-placement="top" title="{{__('messages.lbl_btn.btn_info')}}"
                                       class="button button-sm button-box button-outline button-info">
                                        <i class="fa fa-eye text_white"></i>
                                    </a>
                                    <a href="{{url('admins/invoice/edit')}}/{{$invoice->id}}" data-toggle="tooltip" data-placement="top" title="{{__('messages.lbl_btn.btn_edit')}}"
                                       class="button button-sm button-box button-outline button-primary">
                                        <i class="fa fa-pencil-square-o text_white"></i>
                                    </a>
                                    <button class="button button-sm button-box button-outline button-danger" onclick="deleteInvoice({{$invoice->id}})"
...
@section('modal')
    <div class="modal fade" id="modalInvoice">
        <form role="form" action="{{route('invoice.submit.delete')}}" method="post">
            @csrf
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>{{__('messages.lbl_messages.msg_confirm_delete',['name' => __('messages.lbl_screen_menu.invoice')])}}</p>
                    </div>
