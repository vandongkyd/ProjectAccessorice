                    ...
                    <div class="col-12">
                        <div class="invoice-head row">
                            ...
                            <div class="col-lg-2 col-12 text-right">
                                <a target="_blank" href="{{url("admins/invoice/export")}}/{{$invoice->id}}" role="button" class="mt-10 button button-sm button-outline button-primary button-long text-center">
                                    <span><i class="fa fa-external-link"></i>{{__('messages.lbl_btn.btn_export')}}</span>
                                </a>
                            </div>
