...
@section('title', 'Accessories | '.__('messages.lbl_screen_menu.edit',['name' => __('messages.lbl_screen_menu.shopinfo')]))

@section('content-heading')
    <h3 class="title">{{__('messages.lbl_screen_menu.shopinfo')}} <span>/ {{__('messages.lbl_header_edit')}}</span></h3>
@stop
    ...
    <div class="row">
        <div class="col-12 mb-30">
            <div class="box">
                <div class="box-head">
                    <div class="row">
                        <h3 class="title col-lg-10 col-12">{{__('messages.lbl_screen_menu.edit',['name' => __('messages.lbl_screen_menu.shopinfo')])}}</h3>
                    </div>
                </div>

                <div class="col-lg-12 col-12 mb-30">
                    <div class="box-body">
                        <form id="f_submit" action="{{ route("shop.info.submit.edit") }}" method="post" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="row mbn-20">
                                        ...
                                        <div class="col-12 mb-20">
                                            ...
                                            <input type="text" id="shop_name" class="form-control"
                                                   name="shop_name" value="{{old('shop_name',$shop->shop_name)}}"
                                        ...
                                        <div class="col-12 mb-20">
                                            ...
                                            <input type="text" id="shop_phone" class="form-control"
                                                   name="shop_phone" value="{{old('shop_phone',$shop->shop_phone)}}"
                                        ...
                                        <div class="col-12 mb-20">
                                            ...
                                            <textarea class="form-control" id="shop_address" name="shop_address" placeholder="{{__('messages.lbl_table_shop.shop_address')}}">{{old('shop_address',$shop->shop_address)}}</textarea>
                                        ...
                                        <div class="col-12 mb-20">
                                            ...
                                            <select id="shop_status" class="form-control" name="shop_status">
                                                @foreach(__('messages.lbl_status_list') as $key => $value)
                                                    <option {{old("shop_status",$shop->shop_status) == $key ? 'selected' : ''}} value="{{$key}}">{{$value}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
